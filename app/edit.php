...
<head>
    ...
    <style> body { background-color: theme('colors.board.bg'); font-family: 'Consolas', monospace; } .input-retro { border: 2px solid theme('colors.board.border'); padding: 10px; width: 100%; background: white; } </style>
</head>
