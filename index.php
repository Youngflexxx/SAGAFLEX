...
session_start();
if (isset($_SESSION['user_id'])) { header("Location: /app/home.php"); exit; }
...
<body class="flex flex-col items-center justify-center min-h-screen p-4 border-[10px] border-board-border">
    ...
    <div class="max-w-2xl w-full text-center">
        <img src="./public/logo-gold.png" class="h-40 w-auto mx-auto mb-8 drop-shadow-md">
        ...
        <div class="flex justify-center gap-6 mb-12">
            <a href="./app/login.php" class="btn-retro px-8 py-3 text-xl block min-w-[150px]">ENTRAR</a>
            <a href="./app/register.php" class="border-2 border-black px-8 py-3 text-xl font-bold hover:bg-black hover:text-board-accent transition block min-w-[150px]">REGISTRO</a>
        </div>
